 ...
 */
public class Ruch_watek implements Comparable<Ruch_watek> {

    private Integer zwroc_pole(Ruch_watek.rzad r, Ruch_watek.kolumna k) {
        int x = 0;
        int y = 0;
        switch (r) {
            case RR:
    ...
    private synchronized SI_MIN_MAX_Alfa_Beta_watek.figury[][] zmiana(SI_MIN_MAX_Alfa_Beta_watek.figury[][] szachownica, String lista) {
        ...
        if (this.roszada) {
            ...
            if (!this.dlugaroszada) {
                if (this.czybialy) {
                    wynik[0][4] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[0][7] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[0][5] = SI_MIN_MAX_Alfa_Beta_watek.figury.BWieza;
                    wynik[0][6] = SI_MIN_MAX_Alfa_Beta_watek.figury.BKrol;

                } else {
                    wynik[7][4] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[7][7] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[7][5] = SI_MIN_MAX_Alfa_Beta_watek.figury.CWieza;
                    wynik[7][6] = SI_MIN_MAX_Alfa_Beta_watek.figury.CKrol;

                }
            } else {
                if (this.czybialy) {
                    wynik[0][4] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[0][0] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[0][3] = SI_MIN_MAX_Alfa_Beta_watek.figury.BWieza;
                    wynik[0][2] = SI_MIN_MAX_Alfa_Beta_watek.figury.BKrol;

                } else {
                    wynik[7][4] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[7][0] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
                    wynik[7][3] = SI_MIN_MAX_Alfa_Beta_watek.figury.CWieza;
                    wynik[7][2] = SI_MIN_MAX_Alfa_Beta_watek.figury.CKrol;

                }
            }

        } else {
            wynik[lista.charAt(2) - '1'][lista.charAt(1) - 'A'] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
            if (this.przelot && kolejnosc == figura.Pion) {
                wynik[!this.czybialy ? 3 : 4][lista.charAt(4) - 'A'] = SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
    ...
    private SI_MIN_MAX_Alfa_Beta_watek.figury pozyskaj_figure(char znak) {
        switch (znak) {
            case 'p':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CPion;
            case 'P':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BPion;
            case 'n':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CSkoczek;
            case 'N':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BSkoczek;
            case 'b':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CGoniec;
            case 'B':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BGoniec;
            case 'r':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CWieza;
            case 'R':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BWieza;
            case 'q':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CHetman;
            case 'Q':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BHetman;
            case 'k':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.CKrol;
            case 'K':
                return SI_MIN_MAX_Alfa_Beta_watek.figury.BKrol;

        }
        return SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
    }
    ...
    SI_MIN_MAX_Alfa_Beta_watek.figury[][] chessboard_before = new SI_MIN_MAX_Alfa_Beta_watek.figury[8][8];
    SI_MIN_MAX_Alfa_Beta_watek.figury[][] chessboard_after = new SI_MIN_MAX_Alfa_Beta_watek.figury[8][8];
    ...
    private int wartosc(SI_MIN_MAX_Alfa_Beta_watek.figury f) {
        switch (f) {
            case BGoniec:
            case CGoniec:
                return 350;
    ...
    Ruch_watek(String lista, int sposob, SI_MIN_MAX_Alfa_Beta_watek.figury bity, SI_MIN_MAX_Alfa_Beta_watek.figury[][] szachownica) {
        ...
        atak = bity != SI_MIN_MAX_Alfa_Beta_watek.figury.pustka;
        ...
        czy_szach = RuchZagrozenie_kontrola.szach(SI_MIN_MAX_Alfa_Beta_watek.konwert(chessboard_after), !czybialy);
        switch (sposob) {
            case 1:
    ...
    @Override
    public int compareTo(Ruch_watek obiekt) {

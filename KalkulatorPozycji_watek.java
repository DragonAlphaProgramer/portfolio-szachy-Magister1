 ...
 * @author Patryk
 */
public class KalkulatorPozycji_watek
        implements Kalkulator_watek {


    public final static KalkulatorPozycji_watek INSTANCE = new KalkulatorPozycji_watek();

    public static KalkulatorPozycji_watek get() {
        return INSTANCE;
    }
    ...
    public KalkulatorPozycji_watek() {
        /*for (int x = 0; x < 8; x++) {
            for (int y = 0; y < 8; y++) {
    ...
    @Override
    public int zliczacz(SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie, boolean tura_rywala, boolean przelotcan,
    ...
    private int punktacja(SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie, boolean strona, boolean przelotcan,
            boolean bleft, boolean bright, boolean wleft, boolean wright,
            boolean roszadaB, boolean roszadaC, boolean wykonanaRochB, boolean wykonanaRochC,
            int glebia, int kol) {
    ...
    private int wartosc_bierek(SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie) {
        int wartosc = 0;
        int gonceB = 0;
        int gonceC = 0;
        for (int x = 0; x < 8; x++) {
               ...
               // System.out.println(y+(8*(7-x))+"|"+ustawienie[x][y]);
                switch (ustawienie[x][y]) {
                    case CPion:
                        ...
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNY_PION[x+(7*(7-y))] + "]");
                        break;
                    case CSkoczek:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNY_SKOCZEK[x+(7*(7-y))] + "]");
                        wartosc = wartosc - (300 + BONUS_CZARNY_SKOCZEK[y+(8*(7-x))]);
                        break;
                    case CGoniec:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNY_GONIEC[x+(7*(7-y))] + "]");
                        wartosc = wartosc - (330 + BONUS_CZARNY_GONIEC[y+(8*(7-x))]);
                        gonceC = gonceC + 1;
                        break;
                    case CWieza:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNA_WIEZA[x+(7*(7-y))] + "]");
                        wartosc = wartosc - (500 + BONUS_CZARNA_WIEZA[y+(8*(7-x))]);
                        break;
                    case CHetman:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNY_HETMAN[x+(7*(7-y))] + "]");
                        wartosc = wartosc - (900 + BONUS_CZARNY_HETMAN[y+(8*(7-x))]);
                        break;
                    case CKrol:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_CZARNY_KROL[x+(7*(7-y))] + "]");
                        wartosc = wartosc - (10000 + BONUS_CZARNY_KROL[y+(8*(7-x))]);
                        break;
                    case BPion:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALY_PION[x+(7*(7-y))] + "]");
                        wartosc = wartosc + (100 + BONUS_BIALY_PION[y+(8*(7-x))]);
                        break;
                    case BSkoczek:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALY_SKOCZEK[x+(7*(7-y))] + "]");
                        wartosc = wartosc + (300 + BONUS_BIALY_SKOCZEK[y+(8*(7-x))]);
                        break;
                    case BGoniec:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALY_GONIEC[x+(7*(7-y))] + "]");
                        wartosc = wartosc + (330 + BONUS_BIALY_GONIEC[y+(8*(7-x))]);
                        gonceB = gonceB + 1;
                        break;
                    case BWieza:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALA_WIEZA[x+(7*(7-y))] + "]");
                        wartosc = wartosc + (500 + BONUS_BIALA_WIEZA[y+(8*(7-x))]);
                        break;
                    case BHetman:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALY_HETMAN[x+(7*(7-y))] + "]");
                        wartosc = wartosc + (900 + BONUS_BIALY_HETMAN[y+(8*(7-x))]);
                        break;
                    case BKrol:
                        //System.out.print("[" + (x + 1) + "|" + (char) ('A' + y) + " " + SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[x+(7*(7-y))] + BONUS_BIALY_KROL[x+(7*(7-y))] + "]");
    ...
    private int szachmat(boolean strona, SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie, int glebia, boolean przelotcan, int kol) {
        int[] krol = new int[2];
        if (RuchZagrozenie_kontrola.szach(SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie), !strona)) {
            ...
            for (byte i = 0; i < 8; i++) {
                for (byte j = 0; j < 8; j++) {
                    backup[i][j] = SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[i][j];
                    backup1[i][j] = SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[i][j];
                    backup2[i][j] = SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[i][j];
                    backup3[i][j] = SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie)[i][j];
                    if ((ustawienie[i][j] == SI_MIN_MAX_Alfa_Beta_watek.figury.CKrol && strona)
                            || (ustawienie[i][j] == SI_MIN_MAX_Alfa_Beta_watek.figury.BKrol && !strona)) {
                        krol[0] = i;
                        krol[1] = j;
                    }
                }
    ...
    private int pionkiS(boolean strona, SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie) {
////System.out.printlnln("Wchodzi5");
    ...
    private int stosunek(SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie, boolean b, boolean przelotcan,
            boolean bleft, boolean bright, boolean wleft, boolean wright, boolean roszadaB, boolean roszadaC, int kol) {
        int swoje = (Generator_watek.generuj_posuniecia(ustawienie, b, przelotcan, bleft, bright, wleft, wright, roszadaB, roszadaC, 0, kol, false, true).size());
        int wrogie = Generator_watek.generuj_posuniecia(ustawienie, !b, przelotcan, bleft, bright, wleft, wright, roszadaB, roszadaC, 0, kol, false, true).size();
        //System.out.println((int) ((swoje*10.0f) / wrogie*1.0f));
        if (RuchZagrozenie_kontrola.szach(SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie), !b)) {
            swoje++;
        }
        if (RuchZagrozenie_kontrola.szach(SI_MIN_MAX_Alfa_Beta_watek.konwert(ustawienie), b)) {
            wrogie++;
    ...
    private int ruchy_zbijajace(SI_MIN_MAX_Alfa_Beta_watek.figury[][] ustawienie, boolean strona, boolean przelotcan,
        ...
        Collection<Ruch_watek> lista = Generator_watek.generuj_posuniecia((ustawienie), strona, przelotcan, bleft, bright, wleft, wright, roszadaB, roszadaC, 0, kol, false, false);
        int licznik_ataku = 0;

        if (!lista.isEmpty()) {
            for (Ruch_watek ruch : lista) {
                if (ruch.korzystnosc_bicia != Ruch_watek.figura.Pustka) {
    ...
    private int wartosc(Ruch_watek.figura bierka) {
        switch (bierka) {
            case Pion:
                return 100;
            case Skoczek:
